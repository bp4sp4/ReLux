...
<h2>ReLux Demo - <a target="_blank" href="http://3.34.138.102:8080/main/list-view" >ReLux</a> <br>
...
- 비쥬얼 업데이트를 많이 진행했지만 내가 생각했던것 만큼 이쁘지못해 아쉬웠다.
- 역시 또 프로젝트 진행하면서 기획의 중요성 기능개발을 내가 생각한것만큼 여유있게 일정을 잡았는데 지연된게 많이 아쉬움이 남는다.
